...
class SalaoFestas():
    ...
    def __init__(self):
        print('SalaoFestas :: Agendando salão de festas para o casamento...')
...
class Cliente():
    ...
    def contrata_gerente_eventos(self):
        print('Cliente :: Vou contratar uma empresa de eventos\n')

        ge = GerenciamentoEventos()
        ge.organizar()

    def __del__(self):
        print('Cliente :: Foi muito fácil organizar este evento com o Façade...')
